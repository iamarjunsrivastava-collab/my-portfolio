    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ fontSize: 14, fontWeight: 700, color: "#c9a227", fontFamily: "Arial, sans-serif" }}>
            this is how you fall in love
          </p>
          <p style={{ fontSize: 12, color: "#666", fontFamily: "Arial, sans-serif" }}>
...
// Correct Spotify track ID for "this is how you fall in love" - Jeremy Zucker & Chelsea Cutler
const SPOTIFY_TRACK_ID = "1aEsTgCsv8nOjEgyEoRCpS";
    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <div className="flex items-center justify-center gap-4 mb-5">
            ...
            <img
              ...
              onError={(e) => {
                ...
                if (p && !p.querySelector(".av-fb2")) {
                  ...
                  d.className = "av-fb2";
                  d.style.cssText =
                    "width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:16px;font-weight:700;color:#888;font-family:Arial,sans-serif;";
                  d.textContent = "AS";
                  p.appendChild(d);
                }
              }}
          ...
          >
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#888" strokeWidth="1.5">
      ...
      {/* Contact links */}
      <div style={{ borderTop: "1px solid #d4c9a8" }}>
        {links.map(({ label, icon: Icon, href }) => (
          ...
          >
            <div className="flex items-center gap-3">
              <Icon size={16} strokeWidth={1.5} style={{ color: "#333" }} />
              <span style={{ fontSize: 15, color: "#1a1a1a" }}>{label}</span>
            </div>
            <ArrowRight size={15} strokeWidth={1.5} style={{ color: "#aaa" }} />
          </a>
        ))}
      </div>
